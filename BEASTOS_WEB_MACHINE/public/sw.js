const CACHE = 'beastos-web-v1';
const SHELL = ['/', '/styles.css', '/app.webmanifest', '/icon.svg', '/src/app/app.js', '/src/authority/client.js', '/src/hardware/capabilities.js', '/src/storage/scopes.js'];
