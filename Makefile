...
# Rust validation is opportunistic locally; CI installs/uses cargo.
rust:
	@if command -v cargo >/dev/null 2>&1; then cargo check --manifest-path sdk/rust/Cargo.toml; else echo "cargo not installed; Rust check deferred to CI"; fi
