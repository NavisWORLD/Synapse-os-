...
lint:
	...
	sh -n build/hooks/010-synapse.hook.chroot build/hooks/020-phone-bootstrap.hook.chroot build/hooks/030-native-sdk.hook.chroot build/hooks/040-zeref.hook.chroot rootfs/usr/local/bin/synapse rootfs/usr/local/bin/synapse-phone-bootstrap rootfs/usr/local/bin/synapse-genesis-writer rootfs/usr/local/bin/synapse-usb-flash-server rootfs/usr/local/lib/synapse/vm-smoke rootfs/usr/local/lib/synapse/zeref-runtime rootfs/usr/local/lib/synapse/zeref-ibm-broker rootfs/usr/local/bin/synflow
